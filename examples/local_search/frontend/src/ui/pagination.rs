...
pub fn new(
    ...
    pages_count: impl Signal<Item = usize> + 'static,
) -> impl Element {
...
fn pagination_info(
    current_page: Mutable<usize>,
    pages_count: impl Signal<Item = usize> + 'static + Unpin,
) -> impl Element {
    Paragraph::new()
        .content("Page ")
        .content(
    ...
    El::new()
        ...
        .child(
            Button::new()
                ...
                .label("<")
                .on_press(move || current_page.update(|page| page - 1)),
        )
}
...
fn next_page_button(
    ...
    El::new().s(Visible::with_signal(visible)).child(
        Button::new()
            .s(Outline::inner().width(2))
            .s(RoundedCorners::all(3))
            .s(Padding::new().x(10).y(5))
