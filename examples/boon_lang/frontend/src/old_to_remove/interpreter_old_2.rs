...
pub async fn run(_program: &str) -> impl Element {
                                                                ...
                                                                VariableValue::Object(object) => {
                                                                    match object.variable(&VariableName::new("press")).unwrap().actor().get_value().await {
                                                                        VariableValue::Link(link) => {
                                                                            ...
                                                                            stream::once(async { VariableValue::Number(VariableValueNumber::new(121212.)) })
                                                                            // link_actor.value_changes().then({
                                                                            //     let link_actor = link_actor.clone();
                                                                            //     move |_change| {
                                                                            //         zoon::println!("increment_button change heared!!!!!");
                                                                            //         let link_actor = link_actor.clone();
                                                                            //         async move {
                                                                            //             VariableValue::Number(VariableValueNumber::new(9999.))
    ...
    let element = engine_to_element(engine.clone()).await;
